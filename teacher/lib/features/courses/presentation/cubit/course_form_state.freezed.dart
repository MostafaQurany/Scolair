...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CourseFormState);
}
...
/// @nodoc
class $CourseFormStateCopyWith<$Res>  {
$CourseFormStateCopyWith(CourseFormState _, $Res Function(CourseFormState) __);
}
...
class _Initial implements CourseFormState {
  const _Initial();
...
@override
String toString() {
  return 'CourseFormState.initial()';
}
...
class _Submitting implements CourseFormState {
  const _Submitting();
...
@override
String toString() {
  return 'CourseFormState.submitting()';
}
...
class _Success implements CourseFormState {
  const _Success();
...
@override
String toString() {
  return 'CourseFormState.success()';
}
...
class _Error implements CourseFormState {
...
@override
String toString() {
  return 'CourseFormState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CourseFormStateCopyWith<$Res> {
