...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QuestionFormState);
}
...
/// @nodoc
class $QuestionFormStateCopyWith<$Res>  {
$QuestionFormStateCopyWith(QuestionFormState _, $Res Function(QuestionFormState) __);
}


/// Adds pattern-matching-related methods to [QuestionFormState].
extension QuestionFormStatePatterns on QuestionFormState {
...
class _Initial implements QuestionFormState {
  const _Initial();
...
class _Submitting implements QuestionFormState {
  const _Submitting();
...
@override
String toString() {
  return 'QuestionFormState.submitting()';
}
...
class _Error implements QuestionFormState {
...
@override
String toString() {
  return 'QuestionFormState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $QuestionFormStateCopyWith<$Res> {
