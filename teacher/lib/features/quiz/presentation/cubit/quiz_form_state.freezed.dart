...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QuizFormState);
}
...
/// @nodoc
class $QuizFormStateCopyWith<$Res>  {
$QuizFormStateCopyWith(QuizFormState _, $Res Function(QuizFormState) __);
}


/// Adds pattern-matching-related methods to [QuizFormState].
extension QuizFormStatePatterns on QuizFormState {
...
class _Initial implements QuizFormState {
  const _Initial();
...
class _Submitting implements QuizFormState {
  const _Submitting();
...
@override
String toString() {
  return 'QuizFormState.submitting()';
}
...
class _Success implements QuizFormState {
  const _Success();
...
class _Error implements QuizFormState {
  const _Error(this.message);
  

 final  String message;

/// Create a copy of QuizFormState
...
@override
String toString() {
  return 'QuizFormState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $QuizFormStateCopyWith<$Res> {
