...
part of 'homework_form_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeworkFormState);
}
...
/// @nodoc
class $HomeworkFormStateCopyWith<$Res>  {
$HomeworkFormStateCopyWith(HomeworkFormState _, $Res Function(HomeworkFormState) __);
}


/// Adds pattern-matching-related methods to [HomeworkFormState].
extension HomeworkFormStatePatterns on HomeworkFormState {
...
class _Initial implements HomeworkFormState {
  const _Initial();
...
@override
String toString() {
  return 'HomeworkFormState.initial()';
}
...
class _Submitting implements HomeworkFormState {
  const _Submitting();
...
@override
String toString() {
  return 'HomeworkFormState.submitting()';
}
...
class _Success implements HomeworkFormState {
  const _Success();
...
@override
String toString() {
  return 'HomeworkFormState.success()';
}
...
class _Error implements HomeworkFormState {
  const _Error(this.message);
  

 final  String message;

/// Create a copy of HomeworkFormState
...
@override
String toString() {
  return 'HomeworkFormState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $HomeworkFormStateCopyWith<$Res> {
