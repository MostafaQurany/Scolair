...
- Branch: `teacher`
- Tone: operational and focused.
- Usage: primary blue is dominant; cyan is used as a restrained highlight.
...
- Applied the Stitch palette with teacher role defaults.
