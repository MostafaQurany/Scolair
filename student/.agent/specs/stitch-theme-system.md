...
- Branch: `student`
- Tone: lively and social.
- Usage: cyan is stronger for highlights while primary blue remains the main action color.
...
- Applied the Stitch palette with student role defaults.
